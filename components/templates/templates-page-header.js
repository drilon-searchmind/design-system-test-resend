...
export function TemplatesPageHeader({
  ...
  if (loading && summary == null) {
    ...
    bodyLine = `${summary.total} skabeloner · ${summary.activeCount} aktive · ${summary.deptCoverageNum}/${summary.deptCoverageDen} discipliner · ${summary.totalUsage} gange brugt ved nye opgaver`;
  }
