...
import { portfolioRowIncludedInAnyMonth } from "@/lib/crm/tasks-portfolio-filter";
...
/**
 * @param {{ year?: number; month?: number; periods?: Array<{ year: number; month: number }> }} [opts]
 */
export function getTasksDemoBundle(opts = {}) {
  ...
  /** @type {typeof TASKS} */
  const tasks = TASKS.filter((t) => portfolioRowIncludedInAnyMonth(t, periods)).map((t) =>
