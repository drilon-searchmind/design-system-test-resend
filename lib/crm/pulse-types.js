 ...
 * @property {number} [retainerBase] Static CRM field before signed contracts are added.
 * @property {number} [retainerFromContracts] Sum of signed active retainer/subscription contracts.
