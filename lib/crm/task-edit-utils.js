...
export function taskWireToEditDraft(wire) {
  ...
  return {
    ...
    estimateHours:
      ...
      : "",
    billable: wire.billable === false ? "no" : "yes",
    ...
    isSubTask: wire.isSubTask === true,
    parentTaskId: typeof wire.parentTaskId === "string" ? wire.parentTaskId.trim() : "",
  };
}
...
export function editDraftToPatch(draft) {
  ...
  const body = {
    ...
    hint: draft.hint,
    billable: draft.billable === "yes",
  };
  if (draft.isSubTask !== true) {
