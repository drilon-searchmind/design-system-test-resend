 ...
 * @param {{ parentTitle?: string; parentPriority?: string; parentClientDoc?: Record<string, unknown> | null }} [extras]
 */
 ...
 * @param {Record<string, unknown>} scope
 */
async function enrichTaskWireRowsWithParents(tasks, scope) {
